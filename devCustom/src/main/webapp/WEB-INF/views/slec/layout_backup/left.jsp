...
<section class="honjuTel-section">
	...
	<div class="con">
		<div class="col">
			...
			<div class="box first">
				<div class="name"><span>아버지</span> <strong>이재석</strong></div>
				<div class="honju-btn">
					<a href="javascript:pcAlert();" class="com-btn tel sl">연락하기</a>
					<a href="javascript:pcAlert();" class="com-btn sms">문자보내기</a>
				</div>
			...
			<div class="box">
				<div class="name"><span>어머니</span> <strong>이명숙</strong></div>
				<div class="honju-btn">
					<a href="javascript:pcAlert();" class="com-btn tel sl">연락하기</a>
					<a href="javascript:pcAlert();" class="com-btn sms">문자보내기</a>
				</div>
		...
		<div class="col">
			...
			<div class="box first">
				<div class="name"><span>아버지</span> <strong>송정진</strong></div>
				<div class="honju-btn">
					<a href="javascript:pcAlert();" class="com-btn tel sb">연락하기</a>
					<a href="javascript:pcAlert();" class="com-btn sms">문자보내기</a>
				</div>
			...
			<div class="box">
				<div class="name"><span>어머니</span> <strong>이계숙</strong></div>
				<div class="honju-btn">
					<a href="javascript:pcAlert();" class="com-btn tel sb">연락하기</a>
					<a href="javascript:pcAlert();" class="com-btn sms">문자보내기</a>
				</div>
